@REM sf-cors-proxy launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM SF_CORS_PROXY_config.txt found in the SF_CORS_PROXY_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%SF_CORS_PROXY_HOME%"=="" set "SF_CORS_PROXY_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%SF_CORS_PROXY_HOME%\lib\"
...
set "CFG_FILE=%SF_CORS_PROXY_HOME%\SF_CORS_PROXY_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running sf-cors-proxy.
  echo.
